namespace Dexla.Common.Utilities
{
    public static class DateTimeExtensions
    {
        ...
        public static long GetSecondsTimestamp() => DateTimeOffset.UtcNow.ToUnixTimeSeconds();

        public static long GetTimestampFromNumberOfHours(this long timestamp, int hours)
        {
