...
public class ApiEndpointResponse : ISuccess
{
    ...
    public static ApiEndpoint ResponseToEntity(ApiEndpointResponse response)
    {
        return new ApiEndpoint
        {
            Id = response.Id,
            ApiId = response.DataSourceId,
            BaseUrl = response.BaseUrl,
            RelativeUrl = response.RelativeUrl,
            Description = response.Description,
            MethodType = response.MethodType,
            AuthenticationScheme = response.AuthenticationScheme.ToString(),
            ...
            ErrorExampleResponse = response.ErrorExampleResponse,
            IsServerRequest = response.IsServerRequest,
